...
import { assertValidBolt11 } from './bolt11-validator'
...
export async function fetchLnAddrInvoice (
  ...
  // Syntax first: nothing downstream gets to process a syntactically invalid invoice
  // Yes, even before toLowerCase(), because mixed case is invalid - no exceptions.
  assertValidBolt11(body.pr)
