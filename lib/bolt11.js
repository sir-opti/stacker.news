...
// minimum bolt11 strlen = 4 (lnbc) + 1 (sep) + 111 (sig) + 6 (checksum) = 122
const MIN_BOLT11_STRLEN = 122
export function couldBeBolt11PaymentRequest (value) {
  return typeof value === 'string' && /^ln/i.test(value) && value.length >= MIN_BOLT11_STRLEN
}
