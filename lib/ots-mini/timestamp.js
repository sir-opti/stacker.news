import { HEADER_MAGIC, MAJOR_VERSION, MAX_ATTESTATIONS_PER_TIMESTAMP, TIMESTAMP_RECURSION_LIMIT } from './constants.js'
...
export class Timestamp {
   ...
   */
  constructor (msg) {
    if (!(msg instanceof Buffer) || msg.length < 1 || msg.length > Op.MAX_MSG_LENGTH) {
      throw new Error(`Timestamp(): message must be a buffer between 1 and ${Op.MAX_MSG_LENGTH} bytes long`)
    }
    this.msg = msg // Buffer
